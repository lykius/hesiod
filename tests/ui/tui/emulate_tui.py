...
from tests.conftest import base_cfg_dir, complex_template_file
...
def main() -> None:
    ...
    complex_template_file = cwd / "tests/templates/complex.yaml"
    ...
    # assert cfg["dataset"]["path"] == "/path/to/cifar/100"
